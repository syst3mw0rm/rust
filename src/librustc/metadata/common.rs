...
pub static tag_struct_mut: uint = 0x2a;

pub static tag_item_variances: uint = 0x2b;
pub static tag_mod_impl_trait: uint = 0x2c;
/*
...
pub static tag_item_trait_method_self_ty_region: uint = 0x32;
...
pub static tag_items_data_item_struct_ctor: uint = 0x75;
pub static tag_items_data_item_visibility: uint = 0x76;

pub static tag_link_args: uint = 0x77;
pub static tag_link_args_arg: uint = 0x78;
